...
urlpatterns = [
    ...
    path('meal-plans/<int:plan_id>/add-item/', views.add_meal_item, name="add_meal_item"),
    path('meal-plans/delete-item/<int:item_id>/', views.delete_meal_item, name="delete_meal_item"),
    path('meal-plans/delete/<int:plan_id>/', views.delete_meal_plan, name="delete_meal_plan"),
]
